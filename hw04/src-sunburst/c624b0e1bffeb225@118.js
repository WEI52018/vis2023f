...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>此問卷的工作類型最多的是工作室，其次是替代空間，第三是非營利組織/藝術團體</li>
    <br>
    <li>大部分減少碳排放量的人都是以減少包裝和再生材料為主</li>
    <br>
    <li>美術館和藝術園區工作者在減少碳排放量，則是以節約能源和減少包裝占比最大</li>
  </ul>
</h3>`
)}
...
d3
  .scaleOrdinal()
  .domain(["工作室", "替代空間", "非營利組織/藝術團體", "美術館", "減少包裝材及文宣印製", "使用無毒媒材、再生材料、廢物利用素材等", "工作場所、活動展場的節約能源"])
  //.range(d3.schemePaired)
  .range(["#A8FF24","#CCFF80","#DEFFAC","#EFFFD7","#0080FF","#66B3FF","#ACD6FF"])
  .unknown("#D2E9FF")
)}
